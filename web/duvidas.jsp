        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="box box-warning">
                    ...
                    <div class="box-body"> 
                        <form action="gerenciar_suporte.do" method="post">
                            <div class="col-xs-12"> 
                                ...
                                <div class="form-group">
                                    <label>Assunto:</label>
                                    <input type="text" class="form-control" placeholder="Dúvidas" disabled>
                                    </select>
                                </div>    
                                <div class="form-group">
                                    <label>Descrição:</label>
                                    <textarea class="form-control" rows="3" placeholder="Digite a descrição da dúvida a ser enviada"></textarea>
                                </div>      

...
<html>
    <head>
        ...
        <script>
            var tempo_reload = window.setInterval(carrega, 1000);
            function carrega() {
                $('#vagas').load("carrega_vagas.jsp");
            }
        </script>
        <script>
            ...
            <div class="content-wrapper">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Reportar Problemas</h3>
                    </div>
                    <div class="box-body"> 
                        <form action="http://localhost:8080/ardupark/gerenciar_mensagem.do?InserirMensagemExterna" method="post">
                            <input type="hidden" name="local" id="local">                            
                            <div class="col-xs-12 col-md-offset-2 col-md-8"> 
                                <div class="form-group">
                                    <label>Usuário:</label>
                                    <input type="text" class="form-control" placeholder="<% out.println(nome); %>" disabled>
                                </div> 
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="titulo" required>
                                        ...
                                        <option>Problemas no Estacionamento</option>
                                        <option>Sugestões / Críticas</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Digite a descrição do assunto a ser enviado"></textarea>
                                </div>      
                                <button type="submit" class="btn btn-primary btn-block btn-flat">Enviar</button>
                                <button type="submit" class="btn btn-danger btn-block btn-flat">Voltar</button>
                            </div> 
                        </form>    
                    </div>       
                </div>            

...
public final class suporte_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>ArduPark</title>\n");
      ...
      out.write("        <script>\n");
      out.write("            var tempo_reload = window.setInterval(carrega, 1000);\n");
      out.write("            function carrega() {\n");
      out.write("                $('#vagas').load(\"carrega_vagas.jsp\");\n");
      out.write("            }\n");
      out.write("        </script>\n");
      out.write("        <script>\n");
      out.write("            var segundos = new Number();\n");
      out.write("            var segundos = 0;\n");
      out.write("            var minutos = new Number();\n");
      out.write("            var minutos = 0;\n");
      out.write("            var horas = new Number();\n");
      out.write("            var horas = 0;\n");
      out.write("\n");
      out.write("            var minutos_inf = new Number();\n");
      ...
      out.write("                    <span class=\"logo-mini\"><b>A</b>P</span>\n");
      out.write("                    <span class=\"logo-lg\"><b>Ardu</b>Park</span>\n");
      out.write("                </a>\n");
      ...
      out.write("                            </a>\n");
      out.write("                            <ul class=\"treeview-menu\">\n");
      out.write("                                <li class=\"active\"><a href=\"tag_setor_a.jsp\"><i class=\"fa fa-circle-o\"></i> Setor A - Piso 1</a></li>\n");
      out.write("                            </ul>\n");
      out.write("                        </li>\n");
      ...
      out.write("                        </li>\n");
      out.write("                        <li>\n");
      out.write("                            <a href=\"sobre.jsp\">\n");
      out.write("                                <i class=\"fa fa-th\"></i> <span>Sobre</span>\n");
      out.write("                            </a>\n");
      out.write("                        </li>\n");
      out.write("                        <li>\n");
      out.write("                            <a href=\"duvidas.jsp\">\n");
      ...
      out.write("                        <h3 class=\"box-title\">Reportar Problemas</h3>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"box-body\"> \n");
      out.write("                        <form action=\"http://localhost:8080/ardupark/gerenciar_mensagem.do?InserirMensagemExterna\" method=\"post\">\n");
      out.write("                            <input type=\"hidden\" name=\"local\" id=\"local\">                            \n");
 ...
 out.println(nome); 
      ...
      out.write("                                    <input type=\"text\" class=\"form-control\" name=\"nome\" placeholder=\"Digite seu nome completo\">\n");
      out.write("                                </div>  \n");
      out.write("                                <div class=\"form-group\">\n");
      out.write("                                    <label>Assunto:</label>\n");
      out.write("                                    <select class=\"form-control\" name=\"titulo\" required>\n");
      out.write("                                        <option>Selecione o assunto</option>\n");
      out.write("                                        <option>Problemas no Estacionamento</option>\n");
      out.write("                                        <option>Sugestões / Críticas</option>\n");
      out.write("                                        <option>Elogios</option>\n");
      out.write("                                        <option>Outros</option>\n");
      out.write("                                    </select>\n");
      out.write("                                </div>    \n");
      out.write("                                <div class=\"form-group\">\n");
      out.write("                                    <label>Descrição:</label>\n");
      out.write("                                    <textarea class=\"form-control\" rows=\"3\" placeholder=\"Digite a descrição do assunto a ser enviado\"></textarea>\n");
      out.write("                                </div>      \n");
      out.write("                                <button type=\"submit\" class=\"btn btn-primary btn-block btn-flat\">Enviar</button>\n");
      out.write("                                <button type=\"submit\" class=\"btn btn-danger btn-block btn-flat\">Voltar</button>\n");
      out.write("                            </div> \n");
      out.write("                        </form>    \n");
      out.write("                    </div>       \n");
      out.write("                </div>            \n");
      ...
      out.write("            <script>\n");
      out.write("                $(function() {\n");
      out.write("                    $(\"#local\").val(location.toString());\n");
      out.write("                });\n");
      out.write("            </script>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
